...
namespace ControllerTest
{
    ...
    public class Model_Competition_NextTrackShould
    {
        ...
        {
            _competition.Tracks.Enqueue(new Track("track", new[] { SectionTypes.StartGrid, SectionTypes.Finish }, 1));
            var result = _competition.NextTrack();
        ...
        {
            Track track = new Track("track", new[] { SectionTypes.StartGrid, SectionTypes.Finish }, 1);
            Track track2 = new Track("track2", new[] { SectionTypes.StartGrid, SectionTypes.Finish }, 1);
            _competition.Tracks.Enqueue(track);
